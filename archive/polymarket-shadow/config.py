...
STATIONS = [
    ...
    # --- Europe (10)
    ("EHAM", 52.3105,    4.7683,  "Amsterdam",     "EHAM", "C", "Europe/Amsterdam",    "eu", "open-meteo"),
    ("EGLC", 51.5053,    0.0553,  "London",        "EGLC", "C", "Europe/London",       "eu", "open-meteo"),
    ("LFPB", 48.9694,    2.4414,  "Paris",         "LFPB", "C", "Europe/Paris",        "eu", "open-meteo"),
    ("LEMD", 40.4719,   -3.5626,  "Madrid",        "LEMD", "C", "Europe/Madrid",       "eu", "open-meteo"),
    ("LIMC", 45.6306,    8.7281,  "Milan",         "LIMC", "C", "Europe/Rome",         "eu", "open-meteo"),
    ("EDDM", 48.3538,   11.7861,  "Munich",        "EDDM", "C", "Europe/Berlin",       "eu", "open-meteo"),
    ...
    ("ZBAA", 40.0801,  116.5846,  "Beijing",       "ZBAA", "C", "Asia/Shanghai",       "asia", "open-meteo"),
    ...
    ("ZUCK", 29.7192,  106.6417,  "Chongqing",     "ZUCK", "C", "Asia/Shanghai",       "asia", "open-meteo"),
    ("ZHHH", 30.7838,  114.2081,  "Wuhan",         "ZHHH", "C", "Asia/Shanghai",       "asia", "open-meteo"),
    ("ZSQD", 36.3661,  120.0866,  "Qingdao",       "ZSQD", "C", "Asia/Shanghai",       "asia", "open-meteo"),
    ...
    ("VILK", 26.7606,   80.8893,  "Lucknow",       "VILK", "C", "Asia/Kolkata",        "asia", "open-meteo"),
    ("OPKC", 24.8907,   66.9388,  "Karachi",       "OPKC", "C", "Asia/Karachi",        "asia", "open-meteo"),
    ...
    ("MMMX", 19.4361,  -99.0719,  "Mexico City",   "MMMX", "C", "America/Mexico_City", "latam", "open-meteo"),
    ("MPMG",  8.9734,  -79.5556,  "Panama City",   "MPMG", "C", "America/Panama",      "latam", "open-meteo"),

    # --- North America non-US (1)
    ("CYYZ", 43.6772,  -79.6306,  "Toronto",       "CYYZ", "C", "America/Toronto",     "na", "open-meteo"),

    # --- Africa (1)
    ("FACT",-33.9648,   18.6017,  "Cape Town",     "FACT", "C", "Africa/Johannesburg", "africa", "open-meteo"),
